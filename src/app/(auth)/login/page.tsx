...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[400px] relative z-10 animate-reveal opacity-0">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight brand-text-gradient">Welcome Back</h1>
          <p className="text-white/40 text-sm mt-2">Manage your photography studio with ease</p>
        </div>

        <LoginForm />
        
        <p className="mt-8 text-center text-sm text-white/30 font-mono uppercase tracking-widest">
